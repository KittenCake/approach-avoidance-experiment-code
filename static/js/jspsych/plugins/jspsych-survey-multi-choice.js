...
jsPsych.plugins['survey-multi-choice'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
      ...
      for (var j = 0; j < 1; j++) {
        ...
        if(i == 0){
          ...
          for(y = 10; y <= 90; y++){
            ...
            select1.add( new Option(y,y));
          }
         var div1 = document.querySelector("#jspsych-survey-multi-choice-option-0-0");
         div1.appendChild(select1);
            };

        if(i == 1){

            select2.add( new Option("other","other"));
            select2.add( new Option("male","male"));
            select2.add( new Option("female","female"));
            

         var div2 = document.querySelector("#jspsych-survey-multi-choice-option-1-0");
    ...
    var dictResponse = {
      ...
      "Q0": document.getElementById("select1").value,
      "Q1": document.getElementById("select2").value
    };
