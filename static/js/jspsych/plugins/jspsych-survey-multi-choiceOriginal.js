...
jsPsych.plugins['survey-multi-choiceOriginal'] = (function() {

  var plugin = {};

  plugin.trial = function(display_element, trial) {

    var plugin_id_name = "jspsych-survey-multi-choiceOriginal";
    ...
    for (var i = 0; i < trial.questions.length; i++) {
      ...
      $(question_selector).append(
        '<p class="' + plugin_id_name + '-text survey-multi-choiceOriginal">' + trial.questions[i] + '</p>'
      );
